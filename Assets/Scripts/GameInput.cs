...
{
    private const string PLAYER_PRESS_BINDING = "InputBindings";
    ...
    private void Awake()
    {
        ...
        if (PlayerPrefs.HasKey(PLAYER_PRESS_BINDING))
        {
            _playerInputActions.LoadBindingOverridesFromJson(PlayerPrefs.GetString(PLAYER_PRESS_BINDING));
        }
       ...
       inputAction.PerformInteractiveRebinding(bindingIndex).OnComplete(callback =>
        {
            ...
            PlayerPrefs.SetString(PLAYER_PRESS_BINDING, _playerInputActions.SaveBindingOverridesAsJson());
            PlayerPrefs.Save();
        })
            .Start();
    }
